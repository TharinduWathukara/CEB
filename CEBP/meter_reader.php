  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#about">ADD USAGE</a></li>
...
<div id="about" class="container-fluid text-center">
    <br><h2>ADD USAGE</h2><br><br><br><br><br>
   <form class="form-horizontal" action="other/php/enter_units.php" method="post">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Used units:</label>
      <div class="col-sm-6">          
        <input type="number" min="0" step="1" class="form-control" id="units" placeholder="Enter used units" name="units">
      </div>
    </div>
