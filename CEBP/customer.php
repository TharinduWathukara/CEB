    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#portfolio">PROFILE</a></li>
          ...
          <li><a href="#pricing">USAGE HISTORY</a></li>
...
<div id="pricing" class="container-fluid">
    ...
    <tbody>
        <?php 
        $sql_usage  = "SELECT `year`, `month`,  `no_Of_Units`, `bill_For_That_Month` FROM `used_unites`WHERE customer_ID='$userID'";
        ...
        while($row_usage = $result_usage->fetch_assoc()) {
            ...
            <?php echo $row_usage["no_Of_Units"];?> 
            </td> <td>
            <?php echo $row_usage["bill_For_That_Month"];?> 
                </td></tr>
    <?php	}
    } else {
        //echo "0 results";
...
<div id="contact" class="container-fluid text">
...
<table class="table">
    ...
    <tbody>
      ...
      <tr>
        <td><?php echo 'Rs   .'.$row['last_Bill_Amount'];?></td>
        <td><?php echo 'Rs   .'.$row['current_Outstanding'];?></td>
        <td>
          <?php
            if($row['due_Date']<=0){echo 'due date has passed';}
            else{echo $row['due_Date'];}
