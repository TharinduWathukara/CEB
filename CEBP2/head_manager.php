  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#portfolio">ADD EMPLOYEE</a></li>
...
<div id="portfolio" class="container-fluid text-center bg-grey">
  ...
  <form action="other/php/head_manger_add_employee.php " method="POST"><div class="text-center"><div class="col-sm-10">
  ...
  <select class="form-control" id="aclevel" name="aclevel">
    <option>Branch_manager</option>
    <option>Cashier</option>
    <option>Meter_Reader</option>
...
<div id="pricing" class="container-fluid">
    ...
    <form  method="POST"><div class="text-center"><div class="col-sm-10">
  ...
  <select class="form-control" id="branch" name="branch">
    ...
    <br><br>
      <button type="submit" name="btnDelete" class="btn btn-default">Submit</button></div></div>
  </form>
    ...
    if (isset($_POST['btnDelete'])) {
        ...
        //echo $branch;
        $sql_usage  = "SELECT `year`, `month`,  SUM(`no_Of_Units`)  as units FROM `used_unites`  WHERE branch_ID='$branchID' GROUP by `month`";
